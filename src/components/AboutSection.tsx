...
export const AboutSection = () => {
 ...
 {/* Mobile: Image below title */}
          ...
          <div className="lg:hidden mt-8 mb-6">
            ...
            <span className="text-muted-foreground">8th Dan Shihan Selvey and 3rd Dan Sensei Nikandrovs demonstrate the Long Sword Kata forms of our Tenshin Ryu style.</span>
          </div>
