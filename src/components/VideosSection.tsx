  ...
  <section id="videos" className="py-24 bg-secondary">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          <YouTubeVideo videoId="h17azJvqBpA" caption="Tenshin Ryu Style - First 4 Standing Forms" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <YouTubeVideo videoId="0_6HvDojnxA" caption="2023 - Team Visit Japan - Wakayama Buddhist Temple" />
          <YouTubeVideo videoId="RTZ33OvsmAo" caption="1980s? Otani Sensei Teaching Tenshin Ryu Style - 13th Seiza (seated) form - Seppuku" />
          <YouTubeVideo videoId="_9rTOZ8zbOA" caption="2020 - Shihan Selvey - Japanese Sword advert" />
          {/* <VideoPlaceholder /> */}
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <YouTubeVideo videoId="cJy-R2rj0Mk" caption="1973 Hanshi Box and Shihan Selvey - Judo Demo" />
          <YouTubeVideo videoId="t3jLTid4QDU" caption="1973 Hanshi Box and Shihan Selvey - Judo Demo - Part 2" />
          <YouTubeVideo videoId="88sXOW3aw08" caption="Shihan Selvey - 4 Cuts Tameshigiri" />
        </div>
